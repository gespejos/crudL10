...
Route::delete('/database/destroy/{id}', [Controlador::class, 'destroy'])->name('ruta.destroy');
...
Route::get('/informacion/create', [InformacionController::class, 'create'])->name('informacion.create');
